function calculate() {
    ...
    document.getElementById("result").innerHTML = "Total EXP required: " + TOTAL_EXP_REQUIRED.toLocaleString("en-US") + "<br>" + "ETA: " + Math.ceil(TOTAL_EXP_REQUIRED / EXP_GAIN_PER_DAY) + " days till AR" + WANTED_AR
}